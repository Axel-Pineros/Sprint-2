...
db.getCollection('Restaurants').find({ $and: [{ cuisine: "Seafood" }, { cuisine: { $ne: "American " } }, { cuisine: { $ne: "Chinese" } }, { name: { $not: /^Wil/ } }] }, { restaurant_id: 1, name: 1, borough: 1, cuisine: 1 });
...
db.getCollection('Restaurants').find({ "address.coord.1": { $gt: 42, $lt: 52 } }, { restaurant_id: 1, name: 1, address: 1, borough: 1 });
...
db.getCollection('Restaurants').find({ "name": /.*mon.*/ }, { name: 1, borough: 1, "address.coord": 1, cuisine: 1 });
...
db.getCollection('Restaurants').find({ "name": /^Mad/ }, { name: 1, borough: 1, "address.coord": 1, cuisine: 1 });